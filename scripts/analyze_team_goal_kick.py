...
from app.analytics.team_goal_kick_analyzer import (
    TeamGoalKickAnalyzer,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Анализ ударов от ворот команды"
    )
...
def main() -> int:
    ...
    try:
        ...
        logger.exception(
            "Ошибка анализа ударов от ворот"
        )
        return 1
