...
from app.analytics.team_second_half_analyzer import (
    TeamSecondHalfAnalyzer,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Анализ результатов команды во втором тайме"
    )
...
def main() -> int:
    ...
    try:
        ...
        analyzer = TeamSecondHalfAnalyzer(
            session=session
        )
