...
from app.analytics.team_attack_pressure_analyzer import (
    TeamAttackPressureAnalyzer,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Анализ атакующего давления команды"
    )
...
def main() -> int:
    ...
    try:
        ...
        analyzer = TeamAttackPressureAnalyzer(
            session=session
        )
        ...
        logger.exception(
            "Ошибка анализа атакующего давления"
        )
        return 1
