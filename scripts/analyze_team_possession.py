...
from app.analytics.team_possession_analyzer import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Анализ владения мячом команды"
    )
...
def main() -> int:
    ...
    try:
        ...
        analyzer = TeamPossessionAnalyzer(
            session=session
        )
