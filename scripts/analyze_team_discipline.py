...
from app.analytics.team_discipline_analyzer import (
    TeamDisciplineAnalyzer,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Анализ дисциплины команды"
    )
...
def main() -> int:
    ...
    try:
        ...
        analyzer = TeamDisciplineAnalyzer(
            session=session
        )
        ...
        logger.exception(
            "Ошибка анализа дисциплины команды"
        )
        return 1
