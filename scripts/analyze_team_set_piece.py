...
from app.analytics.team_set_piece_analyzer import (
    TeamSetPieceAnalyzer,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Анализ угловых команды"
    )
...
def main() -> int:
    ...
    try:
        ...
        logger.exception(
            "Ошибка анализа угловых команды"
        )
        return 1
