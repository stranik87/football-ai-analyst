...
from app.analytics.team_goalkeeper_analyzer import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Анализ вратарской статистики команды"
    )
...
def main() -> int:
    ...
    try:
        ...
        analyzer = TeamGoalkeeperAnalyzer(
            session=session
        )
        ...
        logger.exception(
            "Ошибка анализа вратарской статистики"
        )
        return 1
