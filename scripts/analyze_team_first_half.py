...
from app.analytics.team_first_half_analyzer import (
    TeamFirstHalfAnalyzer,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Анализ результатов команды в первом тайме"
    )
...
def main() -> int:
    ...
    try:
        ...
        analyzer = TeamFirstHalfAnalyzer(
            session=session
        )
