...
from app.analytics.team_match_control_analyzer import (
    TeamMatchControlAnalyzer,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Анализ контроля матча командой"
    )
...
def main() -> int:
    ...
    try:
        ...
        analyzer = TeamMatchControlAnalyzer(
            session=session
        )
