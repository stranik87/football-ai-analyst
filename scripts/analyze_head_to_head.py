...
from app.analytics.head_to_head_analyzer import (
    HeadToHeadAnalyzer,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Анализ личных встреч двух команд"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="Количество последних личных встреч",
    )
