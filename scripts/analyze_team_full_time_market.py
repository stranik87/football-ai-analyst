...
from app.analytics.team_full_time_market_analyzer import (
    TeamFullTimeMarketAnalyzer,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Анализ рынков полного матча команды"
    )
...
def main() -> int:
    ...
    try:
        ...
        analyzer = TeamFullTimeMarketAnalyzer(
            session=session
        )
        ...
        logger.exception(
            "Ошибка анализа рынков полного матча"
        )
        return 1
