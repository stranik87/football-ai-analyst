...
from app.analytics.team_defensive_pressure_analyzer import (
    TeamDefensivePressureAnalyzer,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Анализ защитного давления команды"
    )
...
def main() -> int:
    ...
    try:
        ...
        analyzer = TeamDefensivePressureAnalyzer(
            session=session
        )
        ...
        logger.exception(
            "Ошибка анализа защитного давления"
        )
        return 1
