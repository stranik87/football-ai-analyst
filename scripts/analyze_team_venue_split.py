...
from app.analytics.team_venue_split_analyzer import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Сравнение домашней и гостевой формы команды"
        )
    )
...
def main() -> int:
    ...
    try:
        ...
        analyzer = TeamVenueSplitAnalyzer(
            session=session
        )
        ...
        logger.exception(
            "Ошибка анализа домашней и гостевой формы"
        )
        return 1
